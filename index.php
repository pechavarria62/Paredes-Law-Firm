...
<?php include('components/Head.php')?>
    ...
    <main id="main">
        ...
        <div class="container" data-aos="zoom-in">
            ...
            <p> </p>
            <a class="cta-btn" href="pages/Appointments.php">Reservar.</a>
            </div>
        ...
        <div class="container section-title">
            <h2>Testimonios</h2>
            <p>Comentarios y Calificaciones</p>
        </div>
                        ...
                        <?php
                            ...
                            if (!empty($comments)) {
                                foreach ($comments as $key => $line) {
                                    list($first_name, $last_name, $comment) = explode(' | ', $line);
